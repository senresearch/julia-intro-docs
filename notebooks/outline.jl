...
# ╔═╡ 2c53cdf6-1771-4060-8369-e2097c065c13
begin
	using Distributions
	using PlutoUI
	using Plots
...
# ╔═╡ 031a2316-3de2-11ec-3dd6-832fa0eb1e09
html"<button onclick='present()'>present</button>"

# ╔═╡ b955e9f0-f9b8-4910-92e6-bce1f656fb41
md"""
...
# ╔═╡ f65dafdb-cb0b-4b75-926a-5746ff601454
md"""
# Outline
...
- Optimization (SS)
- ML (SS/GF)
- Bayesian inference (SS)
"""

# ╔═╡ 8f5457a2-6f0a-405e-b347-ab9fac1b9633
md"""
# Why Julia?

- Easy to code (expressive)
- Fast runtimes (just-in-time compiler, multiple dispatch)
- Native support for parallelization
- Growing package ecosystem
"""

# ╔═╡ 86c6b3d9-c9b7-4cb3-a710-c00b13ea94e9
md"""
# Power calculation example
"""

# ╔═╡ b257c11e-0c5c-45e4-b58d-e0e305d3b379
md"""
# Power function
"""

# ╔═╡ aaa7eba7-ccb7-47a8-b29a-53d063b12f98
begin
...
# ╔═╡ 25a8bff1-f1a0-4bb3-8770-fdf4e7f53967
md"""
# Interactive power visualization
"""

# ╔═╡ 7db32bdf-bdcb-4a1c-b902-32ae78f6e735
md"""
...
# ╔═╡ 13d1fd71-21ae-4fa5-bc5f-86689a1c4c3f
  begin
    # null mean
    μ0 = 0.0
    σ = 1.0/sqrt(n)
...
# ╔═╡ 92f4800a-f2df-4377-bf18-696551588269
md"""
# Summary

- Attractive language for data science
- Easy to program
- Powerful abstractions
- Interpreted language with speed of compiled language
- Growing package system
"""

# ╔═╡ 76c2f0cb-44a2-45e6-8017-48e024626e1d
md"""
# Why?

- Low entry barrier (Common tasks are similar to familiar languages)
- Can use high-level abstractions (mathematical, conceptual)
- Prototyping speed comparable to R/Python/Matlab; Speed comparable to C

- Code looks like pseudocode (syntactic sugar)
- Not making unnecessary copies of large data (pass by reference)
- Calling other languages is easy
- Greater control and transparency of algorithms
"""
